 ...
 *|           Copyright (C) 2019-2021,2024-2025 LSEG. All rights reserved.
#]=============================================================================]
...
if( UNIX )
	...
	elseif ( ${CMAKE_BUILD_TYPE} STREQUAL "Debug" )
		set ( CMAKE_CXX_FLAGS "${RCDEV_CXX_FLAGS_INIT} -ggdb3 ${CMAKE_FLAGS_CLANG} ${CMAKE_CODE_COVERAGE_FLAGS}"  CACHE STRING "" FORCE)
	elseif ( ${CMAKE_BUILD_TYPE} STREQUAL "OptimizedDebug" )
