...
//APIQA
import com.refinitiv.eta.valueadd.examples.watchlistconsumer.WatchlistConsumerConfig.EventCounter;
//END APIQA
		...
		ReactorJsonConversionEventCallback, ReactorServiceNameToIdCallback, ReactorOAuthCredentialEventCallback
{
	...
	// (requested after initial request) requested
	...
	public WatchlistConsumer()
	{
		...
		// APIQA: reissue test
		viewElementNameList = new ArrayList<>();
		reissueViewFieldList = new ArrayList<>();
		// APIQA
