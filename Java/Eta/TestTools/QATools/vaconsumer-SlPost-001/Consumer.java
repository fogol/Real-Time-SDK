 ...
 *
 * <li>-slpost symbolListName. Specifies that the application should attempt to post messages for specified Symbol List name on the login stream (i.e., off-stream).
 *
		...
		ReactorJsonConversionEventCallback, ReactorServiceNameToIdCallback
{
	...
	private void doPosting(ChannelInfo chnlInfo, int postStreamId) {
	...
	private void initChannelInfo(ChannelInfo chnlInfo)
	{
		...
		chnlInfo.shouldSymbolListPost = consumerCmdLineParser.enableSLPost();
		chnlInfo.symbolListName = consumerCmdLineParser.symbolListName();
