        ...
        ReactorServiceNameToIdCallback
{
    ...
    private void init(String[] args)
    {
        ...
        // API QA
        bindOptions.maxFragmentSize(providerCmdLineParser.maxFragmentSize());
        bindOptions.compressionType(providerCmdLineParser.compressionType());
        bindOptions.compressionLevel(providerCmdLineParser.compressionLevel());
        System.out.println("QA prints test compressionType: " + providerCmdLineParser.compressionType());
        System.out.println("QA prints test compressionLevel: " + providerCmdLineParser.compressionLevel());
        System.out.println("QA prints test ws maxFragmentSize: " + providerCmdLineParser.maxFragmentSize());
        // End API QA
