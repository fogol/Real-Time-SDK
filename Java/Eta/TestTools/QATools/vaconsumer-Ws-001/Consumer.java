 ...
 *
 * <li>-compressionType valid is ZLib, LZ4.
 *
		...
		ReactorJsonConversionEventCallback, ReactorServiceNameToIdCallback
{
	...
	private void initChannelInfo(ChannelInfo chnlInfo)
	{
		...
		//API QA
		chnlInfo.connectOptions.connectionList().get(0).connectOptions().compressionType(consumerCmdLineParser.compressionType());
		System.out.println("QA prints test compressionType: " + consumerCmdLineParser.compressionType());
		//END API QA
