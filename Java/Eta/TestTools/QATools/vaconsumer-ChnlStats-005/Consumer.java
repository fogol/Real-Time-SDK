 ...
 *
 * <li>-uname4 changes the username used when logging into the provider
 *
 * <li>-passwd4 changes the password used when logging into the provider
 *
 * <li>-uname5 changes the username used when logging into the provider
 *
 * <li>-passwd5 changes the password used when logging into the provider
 *
 ...
 *
 * <li>-statisticFilter valid value are READ / WRITE / PING
 *
 * <li>-tokenServiceUrl
 *
 * <li>-serviceDiscoveryUrl
 *
 * <li>-restRequestTimeout
 *
 * <li>-tokenReissueRatio
 *
 * <li>-reissueTokenAttemptLimit
 *
 * <li>-reissueTokenAttemptInterval
 *
		...
		ReactorJsonConversionEventCallback, ReactorServiceNameToIdCallback
{
	...
	private void init(String[] args)
	{
		...
		for (ConnectionArg connectionArg : consumerCmdLineParser.connectionList())
		{
			...
			{
				if (consumerCmdLineParser.userName4() != null && !consumerCmdLineParser.userName4().isEmpty())
				{
					LoginRequest loginRequest = chnlInfo.consumerRole.rdmLoginRequest();
			...
			{
				if (consumerCmdLineParser.userName5() != null && !consumerCmdLineParser.userName5().isEmpty())
				{
					LoginRequest loginRequest = chnlInfo.consumerRole.rdmLoginRequest();
