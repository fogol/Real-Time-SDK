 ...
 * <ul>
 *  <li>-reconnectAttemptLimit specifies the maximum number of reconnection attempts. Default is -1.
 *  <li>-reconnectMinDelay specifies minimum delay (in milliseconds) between reconnection attempts. Default is 500.
 *  <li>-reconnectMaxDelay specifies maximum delay (in milliseconds) between reconnection attempts. Default is 6000.
 * </ul>
 * </li>
 * </ul>
 */
		...
		ReactorJsonConversionEventCallback, ReactorServiceNameToIdCallback
{
	...
	private void initChannelInfo(ChannelInfo chnlInfo)
	{
		...
		chnlInfo.connectOptions.reconnectAttemptLimit(consumerCmdLineParser.reconnectAttemptLimit());
		chnlInfo.connectOptions.reconnectMinDelay(consumerCmdLineParser.reconnectMinDelay());
		chnlInfo.connectOptions.reconnectMaxDelay(consumerCmdLineParser.reconnectMaxDelay());
