...
public class Consumer 
{
	static Map createProgramaticConfig()
	{
		...
		// API QA
		elementList.add(EmaFactory.createElementEntry().intValue("ReactorMsgEventPoolLimit", 100));
		elementList.add(EmaFactory.createElementEntry().intValue("ReactorChannelEventPoolLimit", 150));
		elementList.add(EmaFactory.createElementEntry().intValue("WorkerEventPoolLimit", 100));
		elementList.add(EmaFactory.createElementEntry().intValue("TunnelStreamMsgEventPoolLimit", 150));
		elementList.add(EmaFactory.createElementEntry().intValue("TunnelStreamStatusEventPoolLimit", 100));
		configMap.add(EmaFactory.createMapEntry().keyAscii("GlobalConfig", MapEntry.MapAction.ADD, elementList));
		elementList.clear();
		// End API QA
