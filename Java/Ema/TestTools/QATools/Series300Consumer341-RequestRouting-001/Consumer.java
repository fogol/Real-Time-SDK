...
class AppClient implements OmmConsumerClient
{
	...
	{		
		...
		System.out.println("Domain: "+ refreshMsg.domainType()+ "\nStreamId: "+ refreshMsg.streamId());
	...
	public void onAckMsg(AckMsg ackMsg, OmmConsumerEvent event)
	{
		...
		System.out.println();
		//API QA	
		System.out.println("event session info (ack)\n");
		printSessionInfo(event);		
	}
	...
	{
		if ( ackMsg.hasMsgKey() )
			System.out.println("Domain: "+ ackMsg.domainType()+ "\nStreamId: "+ ackMsg.streamId()
					+ "\nItem Name: " + ( ackMsg.hasName() ? ackMsg.name() : "not set" ) +  "\nService Name: " 
...
public class Consumer 
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			consumer.registerClient(reqMsg.clear().serviceName("DIRECT_FEED").name("LSEG.L"), appClient, consumer);
