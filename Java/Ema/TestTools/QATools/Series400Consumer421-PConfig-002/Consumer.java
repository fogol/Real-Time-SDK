...
public class Consumer 
{
	static Map createProgramaticConfig()
	{
		...
		innerElementList.add(EmaFactory.createElementEntry().intValue( "DispatchTimeoutApiThread", 100 ));
		...
		//APIQA
		innerElementList.add(EmaFactory.createElementEntry().ascii( "Host", "channel1_host"));
		innerElementList.add(EmaFactory.createElementEntry().ascii("Port", "channel1_port"));
		//END APIQA
...
innerMap.add(EmaFactory.createMapEntry().keyAscii( "Channel_1", MapEntry.MapAction.ADD, innerElementList));
		...
		//APIQA
		innerElementList.add(EmaFactory.createElementEntry().ascii( "ChannelType", "ChannelType::channel2Type_input" ));
		innerElementList.add(EmaFactory.createElementEntry().ascii( "CompressionType", "CompressionType::ZLib"));
		innerElementList.add(EmaFactory.createElementEntry().intValue( "GuaranteedOutputBuffers", 5000));
		innerElementList.add(EmaFactory.createElementEntry().intValue( "ConnectionPingTimeout", 50000));
		innerElementList.add(EmaFactory.createElementEntry().ascii( "Host", "channel2_host"));
		innerElementList.add(EmaFactory.createElementEntry().ascii("Port", "channel2_port"));
		//END APIQA
		innerElementList.add(EmaFactory.createElementEntry().intValue( "TcpNodelay", 0));
