 ...
 */
public class PreferredHostInfo {
    ...
    private long _remainingDetectionTime;
     ...
     */
    public long getRemainingDetectionTime() {
        return _remainingDetectionTime ;
    }

    public void setRemainingDetectionTime(long remainingDetectionTime) {
        this._remainingDetectionTime = remainingDetectionTime;
    }
    ...
    public String toString() {
        ...
        _stringBuilder.append("\n\t\tRemainingDetectionTime=" + _remainingDetectionTime);
