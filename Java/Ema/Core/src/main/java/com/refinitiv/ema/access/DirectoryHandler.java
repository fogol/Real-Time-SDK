		...
		case REQUEST:
			{	
			   ...
			   if ( _ommServerBaseImpl.activeConfig().acceptDirMessageWithoutMinFilters || 
					   ( ( directoryRequest.filter() & com.refinitiv.eta.rdm.Directory.ServiceFilterFlags.INFO ) == com.refinitiv.eta.rdm.Directory.ServiceFilterFlags.INFO )
					   && ( ( directoryRequest.filter() & com.refinitiv.eta.rdm.Directory.ServiceFilterFlags.STATE ) == com.refinitiv.eta.rdm.Directory.ServiceFilterFlags.STATE ) )
			   {
