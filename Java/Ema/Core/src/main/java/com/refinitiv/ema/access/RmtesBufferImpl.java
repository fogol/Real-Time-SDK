...
class RmtesBufferImpl implements RmtesBuffer
{
	...
	private com.refinitiv.eta.codec.Buffer _rsslBuffer = CodecFactory.createBuffer();
	...
	private com.refinitiv.eta.codec.RmtesBuffer _rsslRmtesBuffer = CodecFactory.createRmtesBuffer(0, null, 0);
	...
	com.refinitiv.eta.codec.Buffer rsslBuffer()
	{
		return _rsslBuffer;
	}
