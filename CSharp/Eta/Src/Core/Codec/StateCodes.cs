...
namespace LSEG.Eta.Codec
{
	...
	sealed public class StateCodes
	{
		...
		/// </summary>
		/// <param name="stateCode"> <see cref="StateCodes"/> enumeration to convert to string
		/// </param>
		/// <returns> string representation for a state code
		/// </returns>
		...
		/// </summary>
		/// <param name="stateCode"> <see cref="StateCodes"/> enumeration to get info for
		/// </param>
