...
public class WatchlistConsumer : IConsumerCallback, IReactorServiceEndpointEventCallback, IReactorOAuthCredentialEventCallback
{
            ...
            case ReactorChannelEventType.CHANNEL_DOWN_RECONNECTING:
                {
                    ...
                    Console.WriteLine("\nReconect Time: " + formattedDateTime);
                    //End API QA
    ...
    private void InitChannelInfo(ChannelInfo chnlInfo)
    {
        ...
        //API QA
        chnlInfo.ConnectOptions.SetReconnectAttempLimit(m_WatchlistConsumerConfig.ReconnectAttemptLimit);
        chnlInfo.ConnectOptions.SetReconnectMinDelay(m_WatchlistConsumerConfig.ReconnectMinDelay);
        chnlInfo.ConnectOptions.SetReconnectMaxDelay(m_WatchlistConsumerConfig.ReconnectMaxDelay);

        Console.WriteLine("ReconnectAttemptLimit: " + chnlInfo.ConnectOptions.GetReconnectAttemptLimit());
        Console.WriteLine("ReconnectMinDelay: " + chnlInfo.ConnectOptions.GetReconnectMinDelay());
        Console.WriteLine("ReconnectMaxDelay: " + chnlInfo.ConnectOptions.GetReconnectMaxDelay());
        //End API QA
