...
internal class WatchlistConsumerConfig
{
    ...
    public bool EnableSymbolListPost => BoolValue("slpost");

    public string? SlPostName => Value("slname");
    ...
    public void AddCommandLineArgs()
    {
        ...
        AddOption("slpost", "Specifies that the application should attempt to send post message on the symbol list request. Default is false.");
        AddOption("slname", "Specifies name of the symbol list item for posting. Default is null.");
        ...
        AddOption("slpost", "Posts items on the Symbol List domain and data streams for items on that list.  Default is no symbol list post.");
