...
public class IProvider
{
    static Map CreateProgrammaticConfig()
    {
        ...
        innerElementList.AddUInt("AcceptDirMessageWithoutMinFilters", 0);
        innerElementList.AddUInt("AcceptMessageSameKeyButDiffStream", 0);
        innerElementList.AddUInt("AcceptMessageThatChangesService", 0);
        innerElementList.AddUInt("AcceptMessageWithoutAcceptingRequests", 0);
        innerElementList.AddUInt("AcceptMessageWithoutBeingLogin", 0);
        innerElementList.AddUInt("AcceptMessageWithoutQosInRange", 0);
        ...
        innerElementList.AddUInt("OpenLimit", 5);
        innerElementList.AddUInt("OpenWindow", 5);
        innerElementList.AddUInt("LoadFactor", 1);

        elementList.AddElementList("LoadFilter", innerElementList.Complete());
        innerElementList.Clear();
    ...
    public static void Main(string[] args)
    {
        try
        {
            ...
            using OmmProvider provider = new OmmProvider(new OmmIProviderConfig()
                .Config(CreateProgrammaticConfig())
