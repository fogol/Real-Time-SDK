...
The 501_PreferredHost_ProgCfg implements the following high level steps:
...
dotnet run -- -enablePH <true/false> -detectionTimeSchedule <cron_expression> -detectionTimeInterval <detectionTimeInterval> -channelNamePreferred <channelNamePreferred>
