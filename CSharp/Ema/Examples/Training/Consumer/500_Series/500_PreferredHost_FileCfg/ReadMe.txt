...
The 500_PreferredHost_FileCfg application is provided as an example of OMM
...
The 500_PreferredHost_FileCfg example illustrates aspects of the preferred host feature,
...
The 500_PreferredHost_FileCfg example implements the following high level steps:
...
+ Switches over to a preferred host according to a default
