...
internal class AppClient : IOmmConsumerClient
{
    ...
    {
        Console.WriteLine("Received Generic. Item Handle: " + @event.Handle + " Closure: " + (@event.Closure ?? "null"));
    ...
    private void Decode(UpdateMsg updateMsg)
    {
    ...
    private void Decode(ComplexTypeData complexTypeData)
    {
    ...
    private void Decode(GenericMsg genMsg)
    {
