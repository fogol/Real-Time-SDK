...
public partial class Consumer 
{
	static Map CreateProgramaticConfig()
	{
		...
		// API QA
		elementList.AddInt("ReactorMsgEventPoolLimit", 100);
		elementList.AddInt("ReactorChannelEventPoolLimit", 150);
		elementList.AddInt("WorkerEventPoolLimit", 100);
		elementList.AddInt("TunnelStreamMsgEventPoolLimit", 150);
		elementList.AddInt("TunnelStreamStatusEventPoolLimit", 100);
		configMap.AddKeyAscii("GlobalConfig", (int)Eta.Codec.MapEntryActions.ADD, elementList.Complete());
		elementList.Clear();
		// End API QA
