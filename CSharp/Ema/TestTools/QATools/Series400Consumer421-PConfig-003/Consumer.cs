...
public partial class Consumer 
{
	static Map CreateProgramaticConfig()
	{
		...
		innerElementList.AddAscii( "Host", "PHost");
		innerElementList.AddAscii("Port", "PPort");
	...
	public static void Main()
	{
		...
		try
		{
	        ...
	        //APIQA	
			consumer  = new(config.Config(CreateProgramaticConfig()).ConsumerName("Consumer_3").Host("localhost:14002"));
