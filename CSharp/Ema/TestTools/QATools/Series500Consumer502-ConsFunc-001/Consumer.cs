...
public class Consumer
{
    ...
    class CommandConfig
    {
        ...
        public string serviceName1 = "DIRECT_FEED";
        public string serviceName2 = "ELEKTRON_DD";
        public string itemName1 = "TRI.N";
        public string itemName2 = "IBM.N";
    }
        ...
        try
        {
            ...
            while (argsCount < args.Length)
            {
                ...
                else if ("-itemName1".Equals(args[argsCount]))
                {
                    if (argsCount < (args.Length - 1))
                    {
                        config.itemName1 = args[++argsCount];
                    }
                    ++argsCount;
                }
				 else if ("-serviceName1".Equals(args[argsCount]))
                {
                    if (argsCount < (args.Length - 1))
                    {
                        config.serviceName1 = args[++argsCount];
                    }
                    ++argsCount;
                }
                else if ("-itemName2".Equals(args[argsCount]))
                {
                    if (argsCount < (args.Length - 1))
                    {
                        config.itemName2 = args[++argsCount];
                    }
                    ++argsCount;
                }
				 else if ("-serviceName2".Equals(args[argsCount]))
                {
                    if (argsCount < (args.Length - 1))
                    {
                        config.serviceName2 = args[++argsCount];
                    }
                    ++argsCount;
                }
    ...
    public static void Main(string[] args)
    {
        ...
        try
        {
            ...
            consumer.RegisterClient(new RequestMsg()
                .ServiceName(config.serviceName1)
                .Name(config.itemName1), appClient1, 0);
            consumer.RegisterClient(new RequestMsg()
                .ServiceName(config.serviceName2)
                .Name(config.itemName2), appClient2, 0);
