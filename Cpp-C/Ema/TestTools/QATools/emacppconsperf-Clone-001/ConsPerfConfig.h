 ...
 *|           Copyright (C) 2016,2019-2022,2024 LSEG. All rights reserved.
 *|-----------------------------------------------------------------------------
 */
...
public:
	...
	bool			enableMessageQueue;			// Enable message queue to decode messages by a seperate thread.
	Int32			cloneMsgBufSize;			// Specifying buffer size for the cloned message
	Int32			refreshMsgPoolSize;			// Specifying the maximum number of refresh message in its pool
	Int32			updateMsgPoolSize;			// Specifying the maximum number of update message in its pool
	Int32			statusMsgPoolSize;			// Specifying the maximum number of status message in its pool
	Int32			genericMsgPoolSize;			// Specifying the maximum number of generic message in its pool
