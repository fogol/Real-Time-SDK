...
void ElementListEncoder::release()
{
...
void ElementListEncoder::addArray( const EmaString& name, const OmmArray& array )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_ARRAY, "addArray()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addElementList( const EmaString& name, const ElementList& elementList )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_ELEMENT_LIST, "addElementList()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addFieldList( const EmaString& name, const FieldList& fieldList )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_FIELD_LIST, "addFieldList()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addReqMsg( const EmaString& name, const ReqMsg& reqMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addReqMsg()", static_cast<const Data&>(reqMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addRefreshMsg( const EmaString& name, const RefreshMsg& refreshMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addRefreshMsg()", static_cast<const Data&>(refreshMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addStatusMsg( const EmaString& name, const StatusMsg& statusMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addStatusMsg()", static_cast<const Data&>(statusMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addUpdateMsg( const EmaString& name, const UpdateMsg& updateMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addUpdateMsg()", static_cast<const Data&>(updateMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addPostMsg( const EmaString& name, const PostMsg& postMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addPostMsg()", static_cast<const Data&>(postMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addAckMsg( const EmaString& name, const AckMsg& ackMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addAckMsg()", static_cast<const Data&>(ackMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addGenericMsg( const EmaString& name, const GenericMsg& genMsg )
{
	...
	{
		addEncodedEntry( name, RSSL_DT_MSG, "addGenericMsg()", static_cast<const Data&>(genMsg).getEncoder().getEncodedBuffer() );
	}
...
void ElementListEncoder::addMap( const EmaString& name, const Map& map )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_MAP, "addMap()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addVector( const EmaString& name, const Vector& vector )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_VECTOR, "addVector()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addSeries( const EmaString& name, const Series& series )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_SERIES, "addSeries()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addFilterList( const EmaString& name, const FilterList& filterList )
{
	...
	{
		if ( enc.isComplete() )
			addEncodedEntry( name, RSSL_DT_FILTER_LIST, "addFilterList()", enc.getEncodedBuffer() );
		else
		{
...
void ElementListEncoder::addOpaque( const EmaString& name, const OmmOpaque& ommOpaque )
{
	...
	if ( enc.ownsIterator() )
	{
		addEncodedEntry( name, RSSL_DT_OPAQUE, "addOpaque()", enc.getEncodedBuffer());
	}
...
void ElementListEncoder::addXml( const EmaString& name, const OmmXml& ommXml )
{
	...
	if ( enc.ownsIterator() )
	{
		addEncodedEntry( name, RSSL_DT_XML, "addXml()", enc.getEncodedBuffer());
	}
...
void ElementListEncoder::addJson( const EmaString& name, const OmmJson& ommJson )
{
	if ( rsslElementListCheckHasStandardData( &_rsslElementList ) == RSSL_FALSE )
	{
		rsslElementListApplyHasStandardData( &_rsslElementList );
	...
	if ( enc.ownsIterator() )
	{
		addEncodedEntry( name, RSSL_DT_JSON, "addJson()", enc.getEncodedBuffer());
	}
	else if ( static_cast<const Data&>(ommJson).hasDecoder() )
	{
		addEncodedEntry( name, RSSL_DT_JSON, "addJson()", static_cast<Data&>( const_cast<OmmJson&>(ommJson)).getDecoder().getRsslBuffer() );
	}
	else
	{
...
void ElementListEncoder::addAnsiPage( const EmaString& name, const OmmAnsiPage& ommAnsiPage )
{
	...
	if ( enc.ownsIterator() )
	{
		addEncodedEntry( name, RSSL_DT_ANSI_PAGE, "addAnsiPage()", enc.getEncodedBuffer());
	}
